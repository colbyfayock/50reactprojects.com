...
Add a <strong className="text-brand-blue-medium">highlight and share</strong> feature that shows a <strong className="text-brand-purple">share button</strong> when someone <strong className="text-brand-purple">highlights text</strong>.
