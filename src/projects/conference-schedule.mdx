...
Create a <strong className="text-brand-blue-medium">website</strong> with speakers and a schedule for a <strong className="text-brand-purple">React conference</strong>.
