...
Create a <strong className="text-brand-blue-medium">goal management</strong> dashboard to add, track, and modify <strong className="text-brand-purple">your goals</strong>.
