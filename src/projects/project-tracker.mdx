...
Create a <strong className="text-brand-blue-medium">ticketing system</strong> that allows you to create and manage <strong className="text-brand-purple">project issues</strong>.
