...
Create an <strong className="text-brand-blue-medium">admin dashboard</strong> to configure <strong className="text-brand-purple">website settings</strong> that requires user login.
