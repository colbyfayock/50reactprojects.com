...
Create a <strong className="text-brand-blue-medium">CSS library</strong> that includes easy-to-use <strong className="text-brand-purple">loading spinners</strong> and <strong className="text-brand-purple">animations</strong>.
