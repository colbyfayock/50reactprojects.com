...
Create interactive <strong className="text-brand-blue-medium">flash cards</strong> that you can <strong className="text-brand-purple">flip</strong>, <strong className="text-brand-purple">sort</strong>, and <strong className="text-brand-purple">mark as done</strong>.
