...
Create a <strong className="text-brand-blue-medium">Zelda Breath of the Wild game UI</strong> clone that lets someone <strong className="text-brand-purple">select items</strong>.
