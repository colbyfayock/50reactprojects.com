...
Create a custom <strong className="text-brand-blue-medium">GitHub Action</strong> that notifies <strong className="text-brand-purple">Slack</strong> with <strong className="text-brand-purple">pull request updates</strong>.
