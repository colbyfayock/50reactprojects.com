...
Create a <strong className="text-brand-blue-medium">Winamp</strong> clone that uses the <strong className="text-brand-purple">Spotify API</strong> to <strong className="text-brand-purple">play music</strong>.
