...
Create a gallery of <strong className="text-brand-blue-medium">video tutorials</strong> that pulls from a <strong className="text-brand-purple">React YouTube playlist</strong>.
