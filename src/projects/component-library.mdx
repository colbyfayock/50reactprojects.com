...
Create a <strong className="text-brand-blue-medium">component library</strong> for an online <strong className="text-brand-purple">music</strong>, <strong className="text-brand-purple">video games</strong>, and <strong className="text-brand-purple">movies</strong> store.
