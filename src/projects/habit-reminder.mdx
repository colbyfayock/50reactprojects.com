...
Create a <strong className="text-brand-blue-medium">habit tracker</strong> that will remind you every so often to <strong className="text-brand-purple">complete a task</strong>.
