...
Create an <strong className="text-brand-blue-medium">analytics dashboard</strong> that shows <strong className="text-brand-purple">historical performance</strong> of <strong className="text-brand-purple">tech stocks</strong>.
