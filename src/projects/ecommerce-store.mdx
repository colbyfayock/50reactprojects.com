...
Create an <strong className="text-brand-blue-medium">online store</strong> where you can buy <strong className="text-brand-purple">video games</strong> and <strong className="text-brand-purple">fan gear</strong>.
