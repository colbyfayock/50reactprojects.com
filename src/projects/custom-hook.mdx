...
Create a <strong className="text-brand-blue-medium">custom hook</strong> that allows you to fetch the <strong className="text-brand-purple">movies</strong> from the <strong className="text-brand-purple">Lord of the Rings API</strong>.
