...
Create a <strong className="text-brand-blue-medium">bookmark manager</strong> that allows you to store <strong className="text-brand-purple">website links</strong> for later.
