...
Add <strong className="text-brand-blue-medium">Google Analytics</strong> to your webpage to analyze <strong className="text-brand-purple">web traffic</strong> and <strong className="text-brand-purple">performance</strong>.
