...
Add an option to toggle between <strong className="text-brand-blue-medium">dark mode</strong> and <strong className="text-brand-blue-medium">light mode</strong> on a <strong className="text-brand-purple">website</strong> or <strong className="text-brand-purple">app</strong>.
