...
Create a group of <strong className="text-brand-blue-medium">opinion surveys</strong> that rate favorite <strong className="text-brand-purple">technologies</strong> and <strong className="text-brand-purple">entertainment</strong>.
