...
Create a <strong className="text-brand-blue-medium">Next.js starter</strong> that scaffolds a new <strong className="text-brand-purple">blog app</strong> automatically.
