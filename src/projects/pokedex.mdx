...
Create a <strong className="text-brand-blue-medium">Pokédex</strong> that shows a list of all <strong className="text-brand-purple">Pokémon</strong> with links to <strong className="text-brand-purple">stats</strong> of each <strong className="text-brand-purple">Pokémon</strong>.
