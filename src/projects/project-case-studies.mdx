...
Create a <strong className="text-brand-blue-medium">list of projects</strong> that include <strong className="text-brand-purple">case studies</strong> and <strong className="text-brand-purple">details</strong> about the project.
