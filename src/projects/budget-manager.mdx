...
Create a <strong className="text-brand-blue-medium">budget manager</strong> to track and manage <strong className="text-brand-purple">finances</strong> and <strong className="text-brand-purple">expenses</strong>.
