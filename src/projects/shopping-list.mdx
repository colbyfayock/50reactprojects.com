...
Create a <strong className="text-brand-blue-medium">shopping list</strong> to add and manage <strong className="text-brand-purple">groceries to buy at the store</strong>.
