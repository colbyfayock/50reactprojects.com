...
Create a <strong className="text-brand-blue-medium">Tesla touchscreen UI</strong> clone that allows someone to <strong className="text-brand-purple">control simulated car features</strong>.
