...
Add your <strong className="text-brand-blue-medium">GitHub</strong> profile’s <strong className="text-brand-purple">top projects</strong> and <strong className="text-brand-purple">stats</strong> to a website.
