...
Create and deploy a <strong className="text-brand-blue-medium">chat bot</strong> that <strong className="text-brand-purple">interacts with</strong> and <strong className="text-brand-purple">moderates</strong> a <strong className="text-brand-purple">discord</strong> community.
