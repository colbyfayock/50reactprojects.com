...
Create a <strong className="text-brand-blue-medium">mad libs</strong> game with templates to <strong className="text-brand-purple">add words to phrases</strong>.
