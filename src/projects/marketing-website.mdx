...
Create a <strong className="text-brand-blue-medium">marketing website</strong> and <strong className="text-brand-blue-medium">landing page</strong> for a <strong className="text-brand-purple">technology product</strong>.
