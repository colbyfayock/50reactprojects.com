...
Create a <strong className="text-brand-blue-medium">frogger-like game</strong> with a goal of getting a <strong className="text-brand-purple">chicken to cross a road</strong>.
