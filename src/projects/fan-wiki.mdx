...
Create a <strong className="text-brand-blue-medium">fan wiki</strong> that includes all characters of <strong className="text-brand-purple">Futurama</strong> or your favorite <strong className="text-brand-purple">TV show</strong> or <strong className="text-brand-purple">movie</strong>.
