...
Create a <strong className="text-brand-blue-medium">mapping app</strong> that shows the route of a <strong className="text-brand-purple">road trip</strong> across the <strong className="text-brand-purple">country</strong>.
