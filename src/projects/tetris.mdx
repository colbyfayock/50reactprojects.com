...
Create a <strong className="text-brand-blue-medium">tetris-like</strong> game that requires someone to <strong className="text-brand-purple">rotate shapes</strong> to fit like a puzzle.
