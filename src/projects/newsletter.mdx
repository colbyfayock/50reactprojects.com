...
Create a <strong className="text-brand-blue-medium">personal newsletter</strong> and add a <strong className="text-brand-purple">subscribe form</strong> to your website.
