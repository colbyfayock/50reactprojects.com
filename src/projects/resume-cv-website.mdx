...
Create a <strong className="text-brand-blue-medium">website</strong> with your <strong className="text-brand-blue-medium">work experience</strong> that can be used as a <strong className="text-brand-purple">resume</strong> or <strong className="text-brand-purple">CV</strong>.
