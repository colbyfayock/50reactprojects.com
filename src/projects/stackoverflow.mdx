...
Create a <strong className="text-brand-blue-medium">StackOverflow</strong> clone allowing <strong className="text-brand-purple">questions and answers</strong> with code snippets.
