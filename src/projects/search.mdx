...
Add a <strong className="text-brand-blue-medium">search form</strong> and <strong className="text-brand-blue-medium">results page</strong> to a <strong className="text-brand-purple">website</strong> or <strong className="text-brand-purple">app</strong>.
