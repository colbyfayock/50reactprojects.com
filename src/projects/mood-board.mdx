...
Create a <strong className="text-brand-blue-medium">mood board</strong> to upload images and add notes for <strong className="text-brand-purple">project inspiration</strong>.
